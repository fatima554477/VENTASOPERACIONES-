	...
	<div id="content" >     
<?php
// PPPAAAATEAM BUILDING SUPPLY CHAIN CONSULTORIA 

$prefijo = substr($numero_evento_get,0,3);
if($prefijo=='EVE'){
	$COLOR="#1371f0;";
}ELSEIF($prefijo=='EPC'){
	$COLOR="#b52347;";
...
<strong><SPAN style="color:<?php echo $COLOR;?>font-size:17px;">NOMBRE DEL EVENTO&nbsp;:&nbsp;<?php echo  isset($NOMBRE_EVENTO_get)?$NOMBRE_EVENTO_get:'';?>&nbsp;&nbsp;--&nbsp;&nbsp; NÚMERO DE EVENTO&nbsp;:&nbsp;<?php echo  isset($numero_evento_get)?$numero_evento_get:'';?>  </SPAN></strong><strong><p class="mb-0 text-uppercase" style="font-size:22px;">&nbsp;&nbsp;PAGO A PROVEEDORES-VYO</p> </strong> 
