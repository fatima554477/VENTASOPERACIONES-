...
$filtroNombreAyudo = 'LOWER(TRIM(02SUBETUFACTURA.NOMBRE_DEL_AYUDO)) = (
					...
					$filtroNombreEjecutivo = '(LOWER(TRIM(02SUBETUFACTURA.NOMBRE_DEL_EJECUTIVO)) = (
                        ...
                        OR LOWER(TRIM(02SUBETUFACTURA.NOMBRE_DEL_EJECUTIVO)) = (
                            ...
                            SELECT LOWER(TRIM(CONCAT(p.NOMBRE_1, " ", p.APELLIDO_PATERNO)))
...
$filtroNombreUsuario = '(' . $filtroNombreAyudo . ' OR ' . $filtroNombreEjecutivo . ')';
    ...
    $filtroAcceso = '
                    ...
                    (04personal.idPersonal = "' . $_SESSION['idem'] . '" 
                     AND 04personal.autoriza = "si")
					    ...
					    OR ' . $filtroNombreUsuario;

} else {
     $filtroAcceso = $filtroNombreUsuario;
